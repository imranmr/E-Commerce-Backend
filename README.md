# PG_FSD_PHASE_3_Imran_MohdRaji_Virendra_Sharma
...
	Type: GET
o	{token}/purchase/all/date/ascending
...
	Type: GET
o	{token}/purchase/all/date/descending
...
	Type: GET
o	{token}/purchase/all/category/ascending
...
	Type: GET
o	{token}/purchase/all/category/descending
...
![image](https://user-images.githubusercontent.com/46792075/177637780-455dc8d8-3f65-4e34-8505-c478d3fea577.png)
